...
class ControllerFactory:
    ...
    CONTROLLER_TYPES = {
        ...
        "fix": FixConstantController,        # MPC will be added dynamically when mpc_wrappers is imported
        "lcc": LeaderCruiseController,
    }
    ...
    def create(
        ...
        Args:
            controller_type: One of 'pid', 'qcar2_speed', 'cacc', 'sa_acc', 'fix', 'lcc', 'mpc'
