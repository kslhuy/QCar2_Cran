...
class StateBase:
    ...
    def _switch_local_observer(self, observer_type: str) -> bool:
        ...
        """
        try:
            from Development.multi_vehicle_self_driving_RealQcar.qcar_refactor.refs.qcar_origin.Observer.local_state_estimators import LocalEstimatorFactory
    ...
    def _switch_fleet_observer(self, observer_type: str) -> bool:
        ...
        """
        try:
            from Development.multi_vehicle_self_driving_RealQcar.qcar_refactor.refs.qcar_origin.Observer.fleet_state_estimators import FleetEstimatorFactory
