...
from extra.platform.virtual.scenario import VirtualSetup, VirtualVehicleSetup, load_virtual_setup


class VirtualProcessManager(ScenarioPlatformProcessManager):
