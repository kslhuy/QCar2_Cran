...
from core import BaseVehicleIO
...
class QCar2IO(BaseVehicleIO):
    ...
    def _poll_gps(self):
        ...
        try:
            ...
            deadline = time.monotonic() + min(0.05, 1.0 / self._reading_gps_rate_hz)
        ...
        if now - self._sensor_data_cache.gps_timestamp <= 1/self._reading_gps_rate_hz:
            return
