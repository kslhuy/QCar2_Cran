...
from utils.control.controller.controller_fleet_base import ControllerFleetBase


class ControllerFleetLongitudinal(ControllerFleetBase):
    """Use front-vehicle gap for speed control and leave steering at zero."""

    def compute(self, state: VehicleStateEstimate, target: ControllerReference, dt: float) -> ControlCommand:
        del dt
        ...
        return ControlCommand(throttle, 0.0, target_velocity, "fleet_longitudinal_controller")
