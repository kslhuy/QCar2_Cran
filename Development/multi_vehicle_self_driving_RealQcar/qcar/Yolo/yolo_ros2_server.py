...
from limo_yolo import LimoYOLO, DetectionBuffers
...
class YoloRos2Server(Node):
    def __init__(self):
        ...
        self.declare_parameter('video_port', 18766) # Default base video port
        ...
        self.get_logger().info(f"Subscribing to {self.rgb_topic} and {self.depth_topic}")
