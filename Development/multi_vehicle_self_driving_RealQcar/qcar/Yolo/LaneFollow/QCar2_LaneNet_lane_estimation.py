...
myCamRGB  =QCarRealSense(mode='RGB',frameWidthRGB=imageWidth, frameHeightRGB=imageHeight, video3dPort=18805)
...
try:
    ...
    while elapsed_time()<simulationTime:
        ...
        # isolatedLane = myLaneNet.post_process(eps=0.4,      # Lower = stricter clustering
        #                                       min_samples=20, # Lower = faster, more sensitive
        #                                       min_area=50)     # Remove small noise
