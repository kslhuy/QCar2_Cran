...
%   plot_section_f_control_response_batch('ShowAttackStatusRows', true)
%   plot_section_f_control_response_batch('UseBatchFleetGaps', false)
...
addParameter(parser, 'UseBatchFleetGaps', true, @(x) islogical(x) || isnumeric(x));
...
for k = 1:numel(files)
    ...
    summaryOne = plot_section_f_control_response( ...
        ...
        'ShowAccDesiredGap', logical(args.ShowAccDesiredGap), ...
        'ShowAttackStatusRows', logical(args.ShowAttackStatusRows), ...
        'ShowAttackEvents', logical(args.ShowAttackEvents), ...
        'ShowAttackIntervalMarkers', logical(args.ShowAttackIntervalMarkers), ...
        'ShowTrustThreshold', logical(args.ShowTrustThreshold), ...
