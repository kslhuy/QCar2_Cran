...
# Parameter identification setup - spawn only one car

num_cars = 1  # spawn only one car for parameter identification
init_distance = 15  # distance between cars (not used for single car)
...
# For single car parameter identification
mySpawns.robotActors[0].set_led_strip_uniform(color=[40, 0, 0])

# Possess the single car for visualization
mySpawns.robotActors[0].possess()
