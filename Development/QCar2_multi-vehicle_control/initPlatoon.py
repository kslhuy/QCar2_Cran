...
camera.spawn_degrees(location=[650, -21, 8], rotation=[0, 11, 122])
# to switch our view from our current camera to the new camera we just initialized
camera.possess()

# ============== Create Wavy Road at 500m ==============
...
num_segments = 18  # Number of road segments
segment_length = 5.0  # Length of each segment (meters)
num_waves = 2  # Number of complete waves (ensures start and end touch ground)
...
road_thickness = 0.3  # Thickness of road surface
